...
const WomensApparel = () => {
  ...
  // Stable list of 62 products
  const products = useMemo(() => Array.from({ length: 62 }, (_, i) => ({
    id: i + 100, // Unique ID offset from men's apparel
    name: `Elegant Piece ${i + 1}`,
    price: `R ${(300 + (i * 7)).toFixed(2)}`,
    image: womensImg,
  })), []);
      ...
      <div className="mx-auto max-w-[1400px] px-6 py-20 md:px-10">
        <div className="flex items-center gap-4 mb-10">
          ...
          <h1 className="font-display text-5xl font-bold">
            Women's <em className="italic text-muted-foreground">Apparel</em>
          </h1>
        </div>
